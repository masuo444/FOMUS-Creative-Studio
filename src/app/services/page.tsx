...
const services = [
  {
    id: 'ai', title: 'AI導入支援', subtitle: '業務の自動化・効率化を、AIの力で実現します。',
  ...
  {
    id: 'web', title: 'Web制作・リニューアル', subtitle: '御社の「顔」となるWebサイトを、戦略的に構築します。',
  ...
  {
    id: 'dx', title: 'DXコンサルティング', subtitle: '「何から始めるべきか」を、御社と一緒に設計します。',
  ...
  {
    id: 'creative', title: '漫画・クリエイティブ制作', subtitle: '言葉では伝わらないことを、ビジュアルで届けます。',
  ...
  {
    id: 'invoice', title: '請求書・決済システム', subtitle: '請求から入金管理まで、一気通貫で自動化します。',
            ...
            <ScrollReveal>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
                <div className={`md:col-span-5 ${i % 2 === 1 ? 'md:order-2' : ''}`}>
                  <img src={service.image} alt={service.title} className="w-full rounded-xl aspect-[16/10] object-cover" />
                </div>
                <div className={`md:col-span-6 ${i % 2 === 1 ? 'md:order-1 md:col-start-1' : 'md:col-start-7'}`}>
                  ...
                  <h2 className="text-[24px] md:text-[28px] font-bold tracking-tight mb-3">{service.title}</h2>
                  <p className="text-[15px] text-[var(--text-sub)] leading-[2] mb-8">{service.subtitle}</p>
